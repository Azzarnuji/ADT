...
<head>
  ...
  <link rel="preload" as="style" href="<?= base_url('assets/css/aos.css') ?>">
  <link rel="preload" as="style" href="<?= base_url('assets/css/ionicons.min.css') ?>">
  <link rel="preload" as="style" href="<?= base_url('assets/css/bootstrap-datepicker.css') ?>">
  <link rel="preload" as="style" href="<?= base_url('assets/css/jquery.timepicker.css') ?>">
